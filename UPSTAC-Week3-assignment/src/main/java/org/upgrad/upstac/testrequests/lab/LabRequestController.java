...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        try{
            ...
            User tester = this.userLoggedInService.getLoggedInUser();

            // fetch the tests assigned to the current user
            return this.testRequestQueryService.findByTester(tester);
